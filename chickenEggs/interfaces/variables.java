...
public abstract class variables implements GLEventListener {
    ...
    private static String[] ininja = {"Back.png", "ninja star.png", "Digits.png","..png","blank.png"};
    private static String[] ibackgrounds = {"spacee.png" ,"kindpng_6159643.png" };
    ...
    public static int[] ninja = new int[ininja.length];
    public static int[] backgrounds = new int[ninja.length];
    ...
    protected static  void init(GL gl) {
        ...
        prepareimage(folderalphabet, ininja,ninja,gl);
