...
public abstract class variables implements GLEventListener {
    ...
    public static final String[] isounds = {
            "gameover.wav", "button.wav", "fire1.wav", "fire2.wav",
            "fire3.wav", "respawn.wav", "DeadChickenSoundEffect.wav"
    };
    private static final String soundsPath = "chickenEggs//Assets//Sounds//";
    private static final String folderalphabet = "chickenEggs//Assets//Alphabet//";
    private static final String folderchicken = "chickenEggs//Assets//chickenEggObjects//";
    private static final String folderIcons = "chickenEggs//Assets//Icons//";
    private static final String folderbullets = "chickenEggs//Assets//bullets//";
    private static final String folderRockets = "chickenEggs//Assets//Rockets//";
    private static final String[] inumbers = {"0.png", "1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png"};
    private static final String[] iletters = {"a.png", "b.png", "c.png", "d.png", "e.png", "f.png", "g.png", "h.png", "i.png", "j.png", "k.png", "l.png",
            "m.png", "n.png", "o.png", "p.png", "q.png", "r.png", "s.png", "t.png", "u.png", "v.png", "w.png", "x.png", "y.png", "z.png", "blank.png"};
    ...
    private static final String[] iconsCustom = {"add1.png", "add2.png", "minus1.png", "play.png",
            "minus2.png", "right1.png", "right2.png", "left1.png", "left2.png", "RocketIcon.png", "instructions.png",
            "customIcon.png", "top3.png", "settings.png", "shield.png", "reset.png", "lose.png", "win.png", "pause.png"};
    ...
    // sounds
    public static float globalVolume = 0.9f;
    public static Sound[] sounds = new Sound[isounds.length];
    public static int[] player1Controller = {KeyEvent.VK_UP, KeyEvent.VK_DOWN, KeyEvent.VK_RIGHT, KeyEvent.VK_LEFT, KeyEvent.VK_SPACE};
    ...
    protected static void init(GL2 gl) {
        ...
        prepareimage(gl, folderalphabet, inumbers, numbers);
        prepareimage(gl, folderalphabet, iletters, Letters);
        prepareimage(gl, folderalphabet, ihealth, health);
        prepareimage(gl, folderchicken, iegg, egg);
        prepareimage(gl, folderchicken, ichicken, chicken);
        prepareimage(gl, folderIcons, iconsCustom, icons);
        prepareimage(gl, folderchicken, ibackground, background);
        prepareimage(gl, folderbullets, ibullets, bullets);
        prepareimage(gl, folderRockets, irockets, rockets);

        preparingSounds();
    }

    private static void prepareimage(GL2 gl, String firstpath, String[] path, int[] textures) {
    ...
    public static void DrawSprite(GL2 gl, int x, int y, int w, int h, int texture) {
        gl.glEnable(GL.GL_BLEND);
    ...
    public static void DrawSprite(GL2 gl, int x, int y, int w, int h, int texture, int rotate) {
        gl.glEnable(GL.GL_BLEND);
        gl.glBindTexture(GL.GL_TEXTURE_2D, texture);
    ...
    public static boolean isMouseInside() {
        return (xmouse <= xaxis && xmouse >= -xaxis && ymouse <= yaxis && ymouse >= -yaxis);
    }

    public static void rectangle(GL2 gl, int x1, int y1, int x2, int y2) {
        gl.glBegin(GL2.GL_QUADS);
        gl.glVertex2d(x1, y1);
        gl.glVertex2d(x1, y2);
        gl.glVertex2d(x2, y2);
    ...
    public static void circle(GL2 gl, int x, int y, int r) {
        gl.glBegin(GL2.GL_POLYGON);
        for (int i = 0; i < 360; i++) {
            double rad = Math.toRadians(i);
            gl.glVertex2d(x + r * Math.cos(rad), y + r * Math.sin(rad));
        }
        gl.glEnd();
    }
    ...
    public static void initGridindex(drawable[] arr, float xs, float xf, float ys, int w, int h, int gapX, int gapY,
                                     int sind, int eind) {
    ...
    public static drawable[] initwriteString(ArrayList<Character> str, float xs, float xf, float ys, int w,
                                             int h, int gapY) {
