...
public class HomeScreen extends Page {
    ...
    public HomeScreen() {
        ...
        playButton = new NavBtn(-500, -450, 400, 200, icons[10], new GamePage(mousePlayer,keyPlayers,new ArrayList<AiPlayer>(),0), "start the game", 25 ,-500 , icons[icons.length-4],-500 , -420 , 150,150 );
