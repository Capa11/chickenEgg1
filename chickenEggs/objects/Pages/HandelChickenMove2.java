...
public class HandelChickenMove2 extends Page {
    ...
    public HandelChickenMove2() {
        super(background[0]);
        rightToLeftText = initwriteString("this will be fixed", rightToLeftStart, rightToLeftStart + textWidth, 600, 100, 50, 8);
        leftToRightText = initwriteString("this will be fixed", leftToRightStart, leftToRightStart + textWidth, 600, 100, 50, 8);
    }
