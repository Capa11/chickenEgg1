...
public class ControllerScreen extends Page {
    Button player1 = new NavBtn(-200, -100, 350, 100, health[0], new PlayerControllerScreen(this), "player 1", 40);
    Button player2 = new NavBtn(250, -100, 350, 100, health[0], new PlayerControllerScreen(this), "player 2", 40);
    Button player3 = new NavBtn(-200, -300, 350, 100, health[0], new PlayerControllerScreen(this), "player 3", 40);
    Button player4 = new NavBtn(250, -300, 350, 100, health[0], new PlayerControllerScreen(this), "player 4", 40);
    ...
    public void isClicked() {
        for (Button button : buttons) {
            if (button.isInside(lastMouseX, lastMouseY) && button!=buttons.get(0)) {
