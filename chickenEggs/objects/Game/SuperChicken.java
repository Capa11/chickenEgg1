...
public class SuperChicken extends drawable implements Chicken {
    public int health = 3;
    public int eggDuration = 60 ;
    ...
    public SuperChicken(int x, int y, int w, int h, int speed, float xmingame, float xmaxgame, float ymingame, float ymaxgame) {
        super(x, y, w, h , chicken[2]);
        this.health = health;
