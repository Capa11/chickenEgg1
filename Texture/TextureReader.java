...
import com.jogamp.common.nio.Buffers; // ✅ Correct replacement
...
public class TextureReader {
    ...
    private static Texture readPixels(BufferedImage img, boolean storeAlphaChannel) {
        ...
        ByteBuffer unpackedPixels = Buffers.newDirectByteBuffer(packedPixels.length * bytesPerPixel); // ✅ JOGL-safe
